              ...
              <ul class="w3header-cart">
                <li class="wthreecartaits">
                    <span class="my-cart-icon">
                        <i class="fa fa-cart-arrow-down" aria-hidden="true"></i><span class="badge badge-notify my-cart-badge"></span></span>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-12 wthree_banner_bottom_right">
                <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs" role="tablist">
                        <li role="presentation"><a href="mens2_shirt.php" id="home-tab" role="tab">Shirts</a></li>
                        <li role="presentation" class="active"><a href="#" role="tab" id="casual-tab">Tuxedo</a></li>
                    ...
                    <div id="myTabContent" class="tab-content">
                     ...
                     <!-- C A S U A L  -->
                     <div role="tabpanel" class="tab-pane fade active in" id="casual" aria-labelledby="casual-tab">
                        <div class="agile_ecommerce_tabs">
                            <?php
                            if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
                            $start_from = ($page-1) * $results_per_page;
                            $product_array = $db_handle->runQuery("SELECT * FROM ".$datatable." WHERE type='mentuxedo' ORDER BY id DESC LIMIT $start_from, ".$results_per_page);
                        ...
                        <?php 
                        $sql = "SELECT COUNT(id) AS total FROM ".$datatable." WHERE type='mentuxedo' ORDER BY id DESC";
                        ...
                        <div class="row">
                            ...
                            <center>
                                ...
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='mens2_tuxedo.php?page=".$i."'";
