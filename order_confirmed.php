...
$sel_user = "SELECT * FROM orders WHERE order_id='$order_id' ";
    ...
    <body>
        ...
        <div style="background-color: #CECDCD;margin-top: 6%;padding-top: 5%;padding-bottom: 5%;">
            <div class="container">
                ...
                <h4 style="margin-top: 1%;">Your order has been placed. Please go to your <a href="myorders.php">"My Orders"</a> page to view your orders.</h4>
            </div>
        </div>
        <!-- //Winter-Collection -->
        <div style="background-color: #ed671e;padding:1%;margin-right: 5%;margin-left: 5%;">
            <div class="row">
                <div class="col-md-12">
                    <h4 style="float: left;"> Order Confirmation </h4>
                </div>
            </div>
        </div>
        <div style="background-color: #f0f0f0;padding:1%;margin-right: 5%;margin-left: 5%;">
            ...
            <div class="row" style="padding-top: 1%;">
                ...
                <div class="col-md-3">
                    <h4> <?php
                        if ($status == 'pending'){
                            echo '<a href="cancel.php"><button class="btn btn-block btn-danger">Cancel</button></a>';
                        }
                    ?> </h4>
                </div>
                <?php
