    ...
    <div class="agileheader" id="agileitshome">
        ...
        <div class="w3slideraits">
            <div class="fluid_dg_wrap fluid_dg_emboss pattern_1 fluid_dg_white_skin" id="fluid_dg_wrap_4">
                <div data-src="resources/header11.png"></div>
                <div data-src="resources/women.png"></div>
                <div data-src="resources/header2.png"></div>
                <div data-src="resources/women2.png"></div>
            </div>
        </div>
        <!-- //Header-Slider -->
        ...
        <div class="container">
            ...
            <div class="wthreehome-latest-grids">
                <div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid1">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="images/home-latest-1.jpg" alt="CV Online Shopping">
                            <figcaption></figcaption>
                        </figure>
                    </div>
                    <h4>DENIM TOPS</h4>
                    <!-- <h5>Lorem Ipsum Dolor Site Amet</h5> -->
                    <h6><a href="womens2.php">Shop Now</a></h6>
                </div>
                <div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid2">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="images/home-latest-2.jpg" alt="CV Online Shopping">
                            <figcaption></figcaption>
                        </figure>
                    </div>
                ...
                <div class="agilemodel-slider">
                    <div id='film_roll_1'>
                        <div><img src="resources/indexslider/1.jpg" alt="CV Online Shopping"></div>
                        <div><img src="resources/indexslider/2.jpg" alt="CV Online Shopping"></div>
                        <div><img src="resources/indexslider/3.jpg" alt="CV Online Shopping"></div>
                        <div><img src="resources/indexslider/4.jpg" alt="CV Online Shopping"></div>
                    </div>
                </div>
                <!-- //Model-Slider -->
                ...
                <div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid3">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="images/home-latest-3.jpg" alt="CV Online Shopping">
                            <figcaption></figcaption>
                        </figure>
                    </div>
                    <h4>WATCHES</h4>
                ...
                <div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid4">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="images/home-latest-4.jpg" alt="CV Online Shopping">
                            <figcaption></figcaption>
                        </figure>
                    </div>
                    <h4>BEACH WEAR</h4>
    ...
    <div class="wthreewinter-coll">
        <div class="container">
            ...
            <div class="wthreeshop-a">
                <a href="womens2.php">SHOP WINTER COLLECTION</a>
            </div>
        </div>
    </div>
    <!-- //Winter-Collection -->
    ...
    <div class="wthreedenim-coll">
        <div class="style-grids">
            <div class="col-md-6 style-grid style-grid-1">
                <img src="images/style-1.jpg" alt="CV Online Shopping">
                <div class="style-grid-1-text">
                    <h3>DENIM JEANS</h3>
                    <!-- <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur.</p> -->
                    <div class="wthreeshop-a">
                        <a href="womens2.php">SHOP DENIM COLLECTION</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 style-grid style-grid-2">
                <div class="style-image-1">
                    <img src="images/style-2.jpg" alt="CV Online Shopping">
                ...
                <div class="style-image-2">
                    <img src="images/style-3.jpg" alt="CV Online Shopping">
                    <div class="style-grid-2-text">
        ...
        <div class="container">
            ...
            <div class="agileshoppinggrids">
                <div class="col-md-6 agileshoppinggrid agileshoppinggrid1">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="resources/shop/men.jpg" alt="CV Online Shopping">
                            <figcaption></figcaption>
                        </figure>
                    </div>
                </div>
                <div class="col-md-6 agileshoppinggrid agileshoppinggrid2">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="images/womens.jpg" alt="CV Online Shopping">
                            <figcaption></figcaption>
                        </figure>
                    </div>
                </div>
