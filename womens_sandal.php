        ...
        <div class="col-md-12 wthree_banner_bottom_right">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    <li role="presentation"><a href="womens_shirt.php" id="home-tab" role="tab">T-shirts</a></li>
                    <li role="presentation"><a href="womens_skirt.php" role="tab" id="skirts-tab">Skirts</a></li>
                    <li role="presentation"><a href="womens_watch.php" role="tab" id="watches-tab">Watches</a></li>
                    <li role="presentation" class="active"><a href="#" role="tab" id="sandals-tab">Sandals</a></li>
                    <!-- <li role="presentation"><a href="#jewellery" role="tab" id="jewellery-tab" data-toggle="tab" aria-controls="jewellery">Jewelry</a></li> -->
                </ul>

                <div id="myTabContent" class="tab-content">

                   <!-- S A N D A L S  -->
                   <div role="tabpanel" class="tab-pane fade active in" id="sandals" aria-labelledby="sandals-tab">
                    <div class="agile_ecommerce_tabs">
                        <?php
                        if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
                        $start_from = ($page-1) * $results_per_page;
                        $product_array = $db_handle->runQuery("SELECT * FROM ".$datatable." WHERE type='womensandals' ORDER BY id DESC LIMIT $start_from, ".$results_per_page);
                    ...
                    <?php 
                    $sql = "SELECT COUNT(id) AS total FROM ".$datatable." WHERE type='womensandals' ORDER BY id DESC";
                        ...
                        <center>
                            <?php
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='womens_sandal.php?page=".$i."'";
    ...
    <div class="container">
        ...
        <div class="agileinfo_new_products_grids">
            <div class="col-md-3 agileinfo_new_products_grid">
                <?php
                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='womenshirt' ORDER BY id DESC LIMIT 1");
                if (!empty($product_array)) { 
                    foreach($product_array as $key=>$value){
                        ?>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <?php
                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='womenskirt' ORDER BY id DESC LIMIT 1");
                if (!empty($product_array)) { 
                    foreach($product_array as $key=>$value){
                        ?>
                        <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <?php
                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='ladieswatch' ORDER BY id DESC LIMIT 1");
                if (!empty($product_array)) { 
                    foreach($product_array as $key=>$value){
                        ?>
                        <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <?php
                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='womensandals' ORDER BY id DESC LIMIT 1");
                if (!empty($product_array)) { 
                    foreach($product_array as $key=>$value){
                        ?>
                        <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
