                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="sandals" aria-labelledby="sandals-tab">
                            <div class="agile_ecommerce_tabs">
                                ...
                                $product_array = $db_handle->runQuery("SELECT * FROM ".$datatable." WHERE type='mensandals' ORDER BY id DESC LIMIT $start_from, ".$results_per_page);
                            ...
                            <?php 
                            $sql = "SELECT COUNT(id) AS total FROM ".$datatable." WHERE type='mensandals' ORDER BY id DESC";
                            ...
                            <div class="row">
                                ...
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='mens2_sandal.php?page=".$i."'";
