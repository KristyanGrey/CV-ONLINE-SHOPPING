        ...
        <div class="col-md-12 wthree_banner_bottom_right">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><a href="#" role="tab" id="skirts-tab">Skirts</a></li>
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade active in" id="skirts" aria-labelledby="skirts-tab">
                        <div class="agile_ecommerce_tabs">
                            ...
                            $product_array = $db_handle->runQuery("SELECT * FROM ".$datatable." WHERE type='womenskirt' ORDER BY id DESC LIMIT $start_from, ".$results_per_page);
                        ...
                        <?php 
                        $sql = "SELECT COUNT(id) AS total FROM ".$datatable." WHERE type='womenskirt' ORDER BY id DESC";
                        ...
                        <div class="row">
                            ...
                            <center>
                                ...
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='womens_skirt.php?page=".$i."'";
