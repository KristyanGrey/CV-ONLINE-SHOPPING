...
?>
    ...
    <body>
        ...
        <!-- //header -->
        <!-- banner -->
        <div class="banner" id="home1" style="background-image:url(resources/header3.png);background-size:cover;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;-ms-background-size:cover;min-height:700px;">
            <div class="container">
            </div>
        </div>
        <!-- //banner -->
                ...
                <div class="col-md-12 wthree_banner_bottom_right">
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="mens2_tuxedo.php" role="tab" id="casual-tab">Tuxedo</a></li>
                            <li role="presentation"><a href="mens2_watch.php" role="tab" id="watches-tab">Watches</a></li>
                            <li role="presentation"><a href="mens2_sandal.php" role="tab" id="sandals-tab">Sandals</a></li>
                        </ul>
                        ...
                        <div class="row">
                            ...
                            <center>
                                ...
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='mens2.php?page=".$i."'";
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="watches" aria-labelledby="watches-tab">
                                <div class="agile_ecommerce_tabs">
                                    <?php
                                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='menwatch' ORDER BY id ASC");
                                if (!empty($product_array)) { 
                                    foreach($product_array as $key=>$value){
                                ?>
                                        <div class="col-md-4 agile_ecommerce_tab_left">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="sandals" aria-labelledby="sandals-tab">
                                <div class="agile_ecommerce_tabs">
                                    <?php
                                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='mensandals' ORDER BY id ASC");
                                if (!empty($product_array)) { 
                                    foreach($product_array as $key=>$value){
                                ?>
                                        <div class="col-md-4 agile_ecommerce_tab_left">
                             ...
                             <!-- C A S U A L  -->
                            <div role="tabpanel" class="tab-pane fade" id="casual" aria-labelledby="casual-tab">
                                <div class="agile_ecommerce_tabs">
                                    <?php
                                $product_array = $db_handle->runQuery("SELECT * FROM products WHERE type='mentuxedo' ORDER BY id ASC");
                                if (!empty($product_array)) { 
                                    foreach($product_array as $key=>$value){
                                ?>
                                        <div class="col-md-4 agile_ecommerce_tab_left">
