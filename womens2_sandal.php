        ...
        <div class="col-md-12 wthree_banner_bottom_right">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    <li role="presentation"><a href="womens2_shirt.php" id="home-tab" role="tab">T-shirts</a></li>
                    <li role="presentation"><a href="womens2_skirt.php" role="tab" id="skirts-tab">Skirts</a></li>
                    <li role="presentation"><a href="womens2_watch.php" role="tab" id="watches-tab">Watches</a></li>
                                ...
                                foreach($product_array as $key=>$value){
                                    ...
                                    <div class="col-md-4 agile_ecommerce_tab_left">
                                        ...
                                        <div class="simpleCart_shelfItem">
                                            ...
                                            <p><a class="item_add" href="cartAction.php?action=addToCart&id=<?php echo $product_array[$key]["id"]; ?>">Add to cart</a></p>
                                        </div>
                                    </div>
                                    <?php
                                }
                        ...
                        <div class="row">
                            ...
                            <center>
                                ...
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='womens2_sandal.php?page=".$i."'";
