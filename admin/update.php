    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Update stocks</a></li>
                                ...
                                <tbody>
                                    ...
                                    while($row = $rs_result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <input type="text" class="form-control text-center input-sm" name="updateQty" value="<?php echo $row["stock"] ?>">
                                                </center>
                                            </td>
                                        </tr>
                                        <?php 
                ...
                <div class="row">
                    <center>
                        ...
                        for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                            echo "<button class='btn'><a href='update.php?page=".$i."'";
