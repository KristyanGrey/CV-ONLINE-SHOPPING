    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Out of stock</a></li>
            </ul>
        </li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="home.php">Config</a></li>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM ".$datatable." WHERE stock=0 ORDER BY productID ASC LIMIT $start_from, ".$results_per_page;
                            ...
                            while($row = $rs_result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control text-center input-sm .col-md-1" value="<?php echo $row["stock"]; ?>" onchange=""></td>
                                </tr>
                                <?php
                            }
                            ?>
                    ...
                    <?php 
                    $sql = "SELECT COUNT(productID) AS total FROM ".$datatable." WHERE stock=0 ORDER BY productID ASC";
                ...
                <div class="row">
                    <center>
                        ...
                        for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                            echo "<button class='btn'><a href='outOfStock.php?page=".$i."'";
