...
if(isset($_POST['submit'])) {
    ...
    if(gettype($_POST['id'])=="array"){
        foreach($_POST['id'] as $val){
           ...
           $id_c=$val;
           $sql = "UPDATE orders SET status='processing' WHERE id='".$id_c."'";
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    $sql = "SELECT * FROM ".$datatable." WHERE status='pending' ORDER BY created DESC LIMIT $start_from, ".$results_per_page;
                                    ...
                                    if($row = $rs_result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><center><?php if($row["status"] == 'pending'){ echo " <span class='label label-warning'>Pending</span>";} ?></center></td>
                        ...
                        <?php 
                        $sql = "SELECT COUNT(id) AS total FROM ".$datatable." WHERE status='pending' ORDER BY created DESC";
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-block btn-warning" name="submit">Submit</button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <center>
                        ...
                        for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                            echo "<button class='btn'><a href='pending.php?page=".$i."'";
