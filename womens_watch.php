        ...
        <div class="col-md-12 wthree_banner_bottom_right">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><a href="#" role="tab" id="watches-tab">Watches</a></li>
                    <li role="presentation"><a href="womens_sandal.php" role="tab" id="sandals-tab">Sandals</a></li>
                ...
                <div id="myTabContent" class="tab-content">
                 ...
                 <!-- W A T C H E S  -->
                 <div role="tabpanel" class="tab-pane fade active in" id="watches" aria-labelledby="watches-tab">
                    <div class="agile_ecommerce_tabs">
                        <?php
                        if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
                        $start_from = ($page-1) * $results_per_page;
                        $product_array = $db_handle->runQuery("SELECT * FROM ".$datatable." WHERE type='ladieswatch' ORDER BY id DESC LIMIT $start_from, ".$results_per_page);
                    ...
                    <?php 
                    $sql = "SELECT COUNT(id) AS total FROM ".$datatable." WHERE type='ladieswatch' ORDER BY id DESC";
                        ...
                        <center>
                            <?php
                                for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                    echo "<button class='btn'><a href='womens_watch.php?page=".$i."'";
